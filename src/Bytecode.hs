...
data IntTypes = Int8Val Int8 | Int16Val Int16 | Int32Val Int32 | Int64Val Int64 deriving (Show, Eq)

data WordTypes = Word8Val Word8 | Word16Val Word16 | Word32Val Word32 | Word64Val Word64 deriving (Show, Eq)

data FloatingPoint = FloatVal Float | DoubleVal Double deriving (Show, Eq)
...
data Bytecode
    ...
    | Fconst Word8 Float -- push float to stack
...
floatToW8 :: Float -> [Word8]
floatToW8 f = floatingStandardtoWord8 $ getIEEE f
...
toBin (Fconst a b) = [8, a] ++ floatToW8 b
